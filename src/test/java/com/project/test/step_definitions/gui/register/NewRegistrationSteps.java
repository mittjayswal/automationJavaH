package com.project.test.step_definitions.gui.register;


import com.project.test.enums.PermittedCharacters;
import com.project.test.framework.helpers.utils.RandomGenerator;
import com.project.test.page_objects.gui.NewRegistrationPage;
